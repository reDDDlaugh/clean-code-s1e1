...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('.task-list__input[type=text]');
    ...
    if(containsClass){
        ...
        label.classList.remove("task-list__label_completed-tasks");
        label.classList.add("task-list__label_edit-mode");
    }
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    var label = listItem.querySelector(".task-list__label_edit-mode");
    var containsClass=listItem.classList.contains("task-list__item_edit-mode");
    if (!containsClass) {
        label.classList.remove("task-list__label_edit-mode");
        label.classList.add("task-list__label_completed-tasks");
...
//Mark task as incomplete.
    ...
    if (label) {
        label.classList.toggle("task-list__label_completed-tasks");
        label.classList.add("task-list__label_edit-mode");
    }
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".task-list__input[type=checkbox]");
